# # https://github.com/krishnaik06/Langsmith/blob/main/app.py
import os
...
# ==================================================================
# https://docs.smith.langchain.com/tracing/faq/logging_feedback
...
client.create_feedback(
    'a78cf2e3-14f1-435a-81ca-a79b84e1845a',
    key="feedback-key",
    score=1.0,
    comment="comment",
)
